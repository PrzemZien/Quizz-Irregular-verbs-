...
def windowe():
    ...
    def sprawdzanie():
        if y == entry.get():
            sprawdzone["text"] = 'Dobra odpowiedź'
            odpowiedz["text"] = 'Brawo!'
            odpowiedz["fg"] = 'purple'
        else:
            sprawdzone["text"] = 'Zła odpowiedź'
            odpowiedz["text"] = y
    def sprawdzanie1():
        if b == entry1.get():
            sprawdzone1["text"] = 'Dobra odpowiedź'
            odpowiedz1["text"] = 'Brawo!'
            odpowiedz1["fg"] = 'purple'
        else:
            sprawdzone1["text"] = 'Zła odpowiedź'
            odpowiedz1["text"] = b
    def sprawdzanie2():
        if d == entry2.get():
            sprawdzone2["text"] = 'Dobra odpowiedź'
            odpowiedz2["text"] = 'Brawo!'
            odpowiedz2["fg"] = 'purple'
        else:
            sprawdzone2["text"] = 'Zła odpowiedź'
            odpowiedz2["text"] = d
    def sprawdzanie3():
        if f == entry3.get():
            sprawdzone3["text"] = 'Dobra odpowiedź'
            odpowiedz3["text"] = 'Brawo!'
            odpowiedz3["fg"] = 'purple'
        else:
            sprawdzone3["text"] = 'Zła odpowiedź'
            odpowiedz3["text"] = f
    def sprawdzanie4():
        if h == entry4.get():
            sprawdzone4["text"] = 'Dobra odpowiedź'
            odpowiedz4["text"] = 'Brawo!'
            odpowiedz4["fg"] = 'purple'
        else:
            sprawdzone4["text"] = 'Zła odpowiedź'
            odpowiedz4["text"] = h
    def sprawdzanie5():
        if j == entry5.get():
            sprawdzone5["text"] = 'Dobra odpowiedź'
            odpowiedz5["text"] = 'Brawo!'
            odpowiedz5["fg"] = 'purple'
        else:
            sprawdzone5["text"] = 'Zła odpowiedź'
            odpowiedz5["text"] = j
    def sprawdzanie6():
        if l == entry6.get():
            sprawdzone6["text"] = 'Dobra odpowiedź'
            odpowiedz6["text"] = 'Brawo!'
            odpowiedz6["fg"] = 'purple'
        else:
            sprawdzone6["text"] = 'Zła odpowiedź'
            odpowiedz6["text"] = l
    def sprawdzanie7():
        if n == entry7.get():
            sprawdzone7["text"] = 'Dobra odpowiedź'
            odpowiedz7["text"] = 'Brawo!'
            odpowiedz7["fg"] = 'purple'
        else:
            sprawdzone7["text"] = 'Zła odpowiedź'
            odpowiedz7["text"] = n
    def sprawdzanie8():
        if p == entry8.get():
            sprawdzone8["text"] = 'Dobra odpowiedź'
            odpowiedz8["text"] = 'Brawo!'
            odpowiedz8["fg"] = 'purple'
        else:
            sprawdzone8["text"] = 'Zła odpowiedź'
            odpowiedz8["text"] = p
    def sprawdzanie9():
        if z == entry9.get():
            sprawdzone9["text"] = 'Dobra odpowiedź'
            odpowiedz9["text"] = 'Brawo!'
            odpowiedz9["fg"] = 'purple'
        else:
            sprawdzone9["text"] = 'Zła odpowiedź'
            odpowiedz9["text"] = z
    def sprawdzanie10():
        if u == entry10.get():
            sprawdzone10["text"] = 'Dobra odpowiedź'
            odpowiedz10["text"] = 'Brawo!'
            odpowiedz10["fg"] = 'purple'
        else:
            sprawdzone10["text"] = 'Zła odpowiedź'
            odpowiedz10["text"] = u
    def exite():
        window.destroy()
    def again():
